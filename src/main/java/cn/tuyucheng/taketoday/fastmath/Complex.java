 ...
 * 
 * <p>Complex numbers are represented as (real + i * imag), where:
 * <ul>
 *   <li>real - the real part</li>
 *   <li>imag - the imaginary part</li>
 *   <li>i - the imaginary unit (i² = -1)</li>
 * </ul>
 * 
 * <p>Operations return new Complex instances (immutable pattern).
 * 
 * <h2>Example usage:</h2>
 * <pre>{@code
...
public final class Complex {
     ...
     * Optimized for integer exponents.
     */
